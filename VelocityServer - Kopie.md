...
java -Xms1G -Xmx7G -XX:+UseG1GC -XX:G1HeapRegionSize=4M -XX:+UnlockExperimentalVMOptions -XX:+ParallelRefProcEnabled -XX:+AlwaysPreTouch -XX:MaxInlineLevel=15 -jar velocity-3.3.0-SNAPSHOT-390.jar
````
...
java -Xms1G -Xmx7G -jar paper-1.20.4-496.jar --nogui
````
