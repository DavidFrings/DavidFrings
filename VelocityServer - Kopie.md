...
````bash
mkdir ~/test/ && mkdir ~/test/velocity/ & mkdir ~/test/project-1/ & mkdir ~/test/project-2/ & mkdir ~/test/project-3/ & mkdir ~/test/lobby/ & mkdir ~/test/survival/ & mkdir ~/test/test-world/
````

````bash
nano ~/test/minecraft.sh
````
...
````bash
chmod u+x ~/test/minecraft.sh
````

````bash
nano ~/test/connect-minecraft.sh
````
...
````bash
chmod u+x ~/test/connect-minecraft.sh
````

````bash
nano ~/test/start-minecraft.sh
````
...
````bash
chmod u+x ~/test/start-minecraft.sh
````

````bash
nano ~/test/velocity/screen-create.sh
````
...
````bash
chmod u+x ~/test/velocity/screen-create.sh
````

````bash
nano ~/test/project-1/screen-create.sh
````
...
````bash
chmod u+x ~/test/project-1/screen-create.sh
````

````bash
nano ~/test/project-2/screen-create.sh
````
...
````bash
chmod u+x ~/test/project-2/screen-create.sh
````

````bash
nano ~/test/project-3/screen-create.sh
````
...
````bash
chmod u+x ~/test/project-3/screen-create.sh
````

````bash
nano ~/test/lobby/screen-create.sh
````
...
````bash
chmod u+x ~/test/lobby/screen-create.sh
````

````bash
nano ~/test/survival/screen-create.sh
````
...
````bash
chmod u+x ~/test/survival/screen-create.sh
````

````bash
nano ~/test/test-world/screen-create.sh
````
...
````bash
chmod u+x ~/test/test-world/screen-create.sh
````

## Configer all Servers

````bash
cd ~/test/velocity/ && wget https://api.papermc.io/v2/projects/velocity/versions/3.3.0-SNAPSHOT/builds/390/downloads/velocity-3.3.0-SNAPSHOT-390.jar
````

````bash
nano ~/test/velocity/start.sh
````
...
````bash
chmod u+x ~/test/velocity/start.sh
````
...
````bash
cd ~/test/lobby/ && wget https://api.papermc.io/v2/projects/paper/versions/1.20.4/builds/496/downloads/paper-1.20.4-496.jar && echo 'eula=true' > eula.txt && mkdir ~/test/lobby/plugins/ && mkdir ~/test/lobby/plugins/BungeeGuard
````

````bash
nano ~/test/lobby/start.sh
````
