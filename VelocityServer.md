...
````bash
echo '{TWY6fiZc8YaiJQyvBNwOlr1OWf75tiqDG4YrEhZXYY0mah1nyWIbbKGXizPXVrsZ}' > /mnt/Festplatte/Server/Minecraft/Server9-Velocity/velocity/forwarding.secret && nano /mnt/Festplatte/Server/Minecraft/Server9-Velocity/velocity/screen-create.sh && chmod u+x /mnt/Festplatte/Server/Minecraft/Server9-Velocity/velocity/screen-create.sh
````
...
````bash
nano /mnt/Festplatte/Server/Minecraft/Server9-Velocity/survival/screen-create.sh && chmod u+x /mnt/Festplatte/Server/Minecraft/Server9-Velocity/survival/screen-create.sh
````
...
````bash
nano /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/BungeeGuard/config.yml
````
...
````bash
chmod u+x /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh  && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/ && wget https://github.com/lucko/BungeeGuard/releases/download/v1.3.3/BungeeGuard.jar && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/ && wget https://hangarcdn.papermc.io/plugins/ViaVersion/ViaVersion/versions/4.10.2/PAPER/ViaVersion-4.10.2.jar
````

````bash
cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/ && wget https://api.papermc.io/v2/projects/paper/versions/1.20.4/builds/496/downloads/paper-1.20.4-496.jar && echo 'eula=true' > eula.txt && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/start.sh && chmod u+x /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh && mkdir /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/ && mkdir /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/BungeeGuard && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/&& wget https://github.com/lucko/BungeeGuard/releases/download/v1.3.3/BungeeGuard.jar && wget https://hangarcdn.papermc.io/plugins/ViaVersion/ViaVersion/versions/4.10.2/PAPER/ViaVersion-4.10.2.jar && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/spigot.yml /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/spigot.yml && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/BungeeGuard/config.yml /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/BungeeGuard/config.yml
````

````bash
cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-2/ && wget https://api.papermc.io/v2/projects/paper/versions/1.20.4/builds/496/downloads/paper-1.20.4-496.jar && echo 'eula=true' > eula.txt && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-2/start.sh && chmod u+x /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh && mkdir /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-2/plugins/ && mkdir /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-2/plugins/BungeeGuard && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/&& wget https://github.com/lucko/BungeeGuard/releases/download/v1.3.3/BungeeGuard.jar && wget https://hangarcdn.papermc.io/plugins/ViaVersion/ViaVersion/versions/4.10.2/PAPER/ViaVersion-4.10.2.jar && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/spigot.yml /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-2/spigot.yml && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/BungeeGuard/config.yml /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-2/plugins/BungeeGuard/config.yml
````

````bash
cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-3/ && wget https://api.papermc.io/v2/projects/paper/versions/1.20.4/builds/496/downloads/paper-1.20.4-496.jar && echo 'eula=true' > eula.txt && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-3/start.sh && chmod u+x /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh && mkdir /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-3/plugins/ && mkdir /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-3/plugins/BungeeGuard && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/&& wget https://github.com/lucko/BungeeGuard/releases/download/v1.3.3/BungeeGuard.jar && wget https://hangarcdn.papermc.io/plugins/ViaVersion/ViaVersion/versions/4.10.2/PAPER/ViaVersion-4.10.2.jar && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/spigot.yml /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-3/spigot.yml && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/BungeeGuard/config.yml /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-3/plugins/BungeeGuard/config.yml
````

````bash
cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/survival/ && wget https://api.papermc.io/v2/projects/paper/versions/1.20.4/builds/496/downloads/paper-1.20.4-496.jar && echo 'eula=true' > eula.txt && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh /mnt/Festplatte/Server/Minecraft/Server9-Velocity/survival/start.sh && chmod u+x /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh && mkdir /mnt/Festplatte/Server/Minecraft/Server9-Velocity/survival/plugins/ && mkdir /mnt/Festplatte/Server/Minecraft/Server9-Velocity/survival/plugins/BungeeGuard && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/&& wget https://github.com/lucko/BungeeGuard/releases/download/v1.3.3/BungeeGuard.jar && wget https://hangarcdn.papermc.io/plugins/ViaVersion/ViaVersion/versions/4.10.2/PAPER/ViaVersion-4.10.2.jar && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/spigot.yml /mnt/Festplatte/Server/Minecraft/Server9-Velocity/survival/spigot.yml && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/BungeeGuard/config.yml /mnt/Festplatte/Server/Minecraft/Server9-Velocity/survival/plugins/BungeeGuard/config.yml
````

````bash
cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/test-world/ && wget https://api.papermc.io/v2/projects/paper/versions/1.20.4/builds/496/downloads/paper-1.20.4-496.jar && echo 'eula=true' > eula.txt && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh /mnt/Festplatte/Server/Minecraft/Server9-Velocity/test-world/start.sh && chmod u+x /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/start.sh && mkdir /mnt/Festplatte/Server/Minecraft/Server9-Velocity/test-world/plugins/ && mkdir /mnt/Festplatte/Server/Minecraft/Server9-Velocity/test-world/plugins/BungeeGuard && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/&& wget https://github.com/lucko/BungeeGuard/releases/download/v1.3.3/BungeeGuard.jar && wget https://hangarcdn.papermc.io/plugins/ViaVersion/ViaVersion/versions/4.10.2/PAPER/ViaVersion-4.10.2.jar && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/spigot.yml /mnt/Festplatte/Server/Minecraft/Server9-Velocity/test-world/spigot.yml && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/BungeeGuard/config.yml /mnt/Festplatte/Server/Minecraft/Server9-Velocity/test-world/plugins/BungeeGuard/config.yml
````
